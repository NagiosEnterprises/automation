...
---
module: timeperiod
short_description: Manage time periods in Nagios XI
description:
  - Create, update, and delete C(timeperiod) objects through the Nagios XI
    REST API (C(config/timeperiod) endpoints of the Core Config Manager).
