...
---
module: command
short_description: Manage command definitions in Nagios XI
description:
  - Create, update, and delete C(command) objects through the Nagios XI
    REST API (C(config/command) endpoints of the Core Config Manager).
