...
DOCUMENTATION = r'''
---
module: hostdependency
short_description: Manage host dependencies in Nagios XI
description:
  - Create, update, and delete C(hostdependency) objects through the Nagios XI
    REST API (C(config/hostdependency) endpoints of the Core Config Manager).
...
EXAMPLES = r'''
- name: Ensure hostdependency exists
...
def main():
    run_config_module('hostdependency')
