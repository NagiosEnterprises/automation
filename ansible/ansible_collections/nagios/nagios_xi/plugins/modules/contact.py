...
---
module: contact
short_description: Manage contacts in Nagios XI
description:
  - Create, update, and delete C(contact) objects through the Nagios XI
    REST API (C(config/contact) endpoints of the Core Config Manager).
